const CACHE="scene-box-v42";
const APP=["./tutorial.js","./google-config.js","./scene-data.js","./scene-categories.js?v=28","./drive-rules.js","./drive-sync.js","./","./index.html","./manifest.webmanifest","./icon-photo-192.png","./icon-photo-512.png","./icon-photo-maskable-512.png"];
